...
export default function AddRiskDialog({
  ...
  React.useEffect(() => {
    if (nodeToEdit) {
      setFormData({
        ...
        likelihood: nodeToEdit.likelihood || "Low",
        impact: nodeToEdit.impact || "Low",
        status: nodeToEdit.status || "Open",
      });
    } else {
      setFormData({
        name: "",
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>{nodeToEdit ? "Edit Risk" : "Add New Risk"}</DialogTitle>
